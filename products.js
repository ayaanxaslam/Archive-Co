/* ============================================================
   ...
   Each piece:
     ...
     img       path to photo e.g. "piece-01.jpg" (optional)
...
/* ------------------------------------------------------------
   One catalogue, two runtimes.

   In the browser this file is a plain <script> and the two consts
   above are simply globals. In Node (the /api/checkout function)
   this export is what makes the SAME price list available server
   side — so the amount Stripe charges is always read from here,
   never sent up from the browser.

   The guard is required: `module` does not exist in the browser.
   ------------------------------------------------------------ */
if (typeof module !== "undefined" && module.exports) {
  module.exports = { PRODUCTS, CATEGORY_META };
}
